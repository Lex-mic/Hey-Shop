...
type = st.sidebar.selectbox("Select a transcription method", ['YouTube Transcription', 'Real-Time Transcription'])
...
if type == 'YouTube Transcription':
	st.title('YouTube Speech-to-Text')

	link = st.text_input('Enter your YouTube link below','https://www.youtube.com/watch?v=SrZemeuleDQ')
	st.video(link)
	...
	st.title('Real-Time Text Transcription')
